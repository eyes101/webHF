...
export default function ProductDetailPage() {
  ...
  const isServiceItem = product.tag === 'Service' || product.category === 'cleaning' || product.unit?.toLowerCase().includes('scope') || product.unit?.toLowerCase().includes('project') || product.unit?.toLowerCase().includes('sqm');
        ...
        <div className="product-info-hub">
          ...
          <div className="product-purchase-box">
            ...
            <div className="product-cta-buttons">
              ...
              >
                {isServiceItem ? '📋 Add to Request List' : '🛒 Add to Cart'}
              </button>
              ...
              >
                {isServiceItem ? '⚡ Request Now' : '⚡ Request & Buy Now'}
              </button>

              <a
                href={whatsappLink(`Hello Halfcon, I am on the website viewing "${product.name}" (${formatNaira(product.price_cents)}) and would like to place a request.`)}
                target="_blank"
              ...
              >
                ...
                {isServiceItem ? 'Request on WhatsApp' : 'Order on WhatsApp'}
              </a>
            </div>
          </div>
